...
final class WhisperProvider: TranscriptionProvider {
    ...
    func transcribe(_ samples: [Float]) async throws -> ASRTranscriptionResult {
        guard let whisper = whisper else {
            throw NSError(domain: "WhisperProvider", code: -1,
    ...
    private func downloadModel(progressHandler: ((Double) -> Void)?) async throws {
        ...
        do {
            ...
            guard httpResponse.statusCode == 200 else {
                throw NSError(domain: "WhisperProvider", code: httpResponse.statusCode,
            ...
            if error.domain == NSURLErrorDomain {
                ...
                throw NSError(domain: "WhisperProvider", code: error.code,
